"""
Django settings for heros_48349 project.
...
WSGI_APPLICATION = 'heros_48349.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "heros_48349 API",
    "DESCRIPTION": "API documentation for heros_48349 App",
    "VERSION": "v1",
}
